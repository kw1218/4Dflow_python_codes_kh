...
#-----------------------------------------------------------------------------------------------------------------------
## Options
dataDir = r'D:/InletProfileStudy/Sorted_data/TBAD36' # directory containing 4Dflow dicom images
saveDir = r'D:/InletProfileStudy/VTKfiles/TBAD36/' # directory where you want to save vtk files
subject_id = 'TBAD36'
venc = [130, 130, 190] # must be in order of sequence number
flipX, flipY, flipZ = True, False, False #assumes images are lr, pa, fh
minusU, minusV, minusW = True, True, False #assumes images are lr, pa, fh
write_pcmra = True
phaseCoeff = 10.0
magCoeff = 1.0
...
# def write4DData(data, path, prefix=''):
...
# write4DData(allData, saveDir, prefix)
