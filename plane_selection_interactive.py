...
#-----------------------------------------------------------------------------------------------------------------------
## Options
outputDir = 'D:/InletProfileStudy/VTPfiles/Interactive/' # path for saving probed .vtp files
saveName = 'Interactive_test'   # filename of resamples .vtp files
source_flow_dir = 'D:/InletProfileStudy/VTKfiles/TBAD01/flow' # directory containing .vtk files of a 4D flow acquisition (processed by dicoms_to_vtk.py)
source_mask_fn = 'D:/InletProfileStudy/VTPfiles/TBAD01_circle/' # path of the .vtk file containing the binary segmentation mask: it must be aligned with .vtk 4D flow files
...
surf = mask.smooth(n_iter=1000, relaxation_factor=0.01)
